...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    private void initialize(GL10 gl) {
        ...
        GLES32.glBindVertexArray(vao_pyramid[0]);
            ...
            GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, pyramidColor.length * 4, verticesBuffer, GLES32.GL_STATIC_DRAW);
        ...
        GLES32.glBindVertexArray(vao_cube[0]);
            ...
            GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, cubeColor.length * 4, verticesBuffer, GLES32.GL_STATIC_DRAW);
            GLES32.glVertexAttribPointer(GLESMacros.RSK_ATTRIBUTE_COLOR, 3, GLES32.GL_FLOAT, false,0,0);
            GLES32.glEnableVertexAttribArray(GLESMacros.RSK_ATTRIBUTE_COLOR);
            GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER,0);
