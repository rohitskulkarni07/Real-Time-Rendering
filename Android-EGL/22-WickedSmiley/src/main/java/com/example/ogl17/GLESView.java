...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    private float quadTexCoord2f[] = new float[8];

    private int pressed_digit = 0;
    ...
    private int texture_enable_uniform;
    ...
    private void initialize(GL10 gl) {
        ...
        texture_enable_uniform  = GLES32.glGetUniformLocation(shaderProgramObject, "u_texture_enable");
        ...
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, quadTexCoord2f.length * 4, verticesBuffer_quad, GLES32.GL_DYNAMIC_DRAW);
    ...
    private void display() {
        ...
        GLES32.glUseProgram(shaderProgramObject);
		    ...
		    GLES32.glBindTexture(GLES32.GL_TEXTURE_2D, smiley_texture[0]);		//change state to texture for next upcoming geometry
		    GLES32.glUniform1i(texture_sampler_uniform, 0);

            if (pressed_digit == 1) {
                quadTexCoord2f[0] = 1.0f; quadTexCoord2f[1] = 1.0f;
                quadTexCoord2f[2] = 0.0f; quadTexCoord2f[3] = 1.0f;
                quadTexCoord2f[4] = 0.0f; quadTexCoord2f[5] = 0.0f;
                quadTexCoord2f[6] = 1.0f; quadTexCoord2f[7] = 0.0f;
                GLES32.glUniform1i(texture_enable_uniform, 1);
        
            }
            else if (pressed_digit == 2) {
                quadTexCoord2f[0] = 0.5f; quadTexCoord2f[1] = 0.5f;
                quadTexCoord2f[2] = 0.0f; quadTexCoord2f[3] = 0.5f;
                quadTexCoord2f[4] = 0.0f; quadTexCoord2f[5] = 0.0f;
                quadTexCoord2f[6] = 0.5f; quadTexCoord2f[7] = 0.0f;
                GLES32.glUniform1i(texture_enable_uniform, 1);
        
            }
            else if (pressed_digit == 3) {
                quadTexCoord2f[0] = 2.0f; quadTexCoord2f[1] = 2.0f;
                quadTexCoord2f[2] = 0.0f; quadTexCoord2f[3] = 2.0f;
                quadTexCoord2f[4] = 0.0f; quadTexCoord2f[5] = 0.0f;
                quadTexCoord2f[6] = 2.0f; quadTexCoord2f[7] = 0.0f;
                GLES32.glUniform1i(texture_enable_uniform, 1);
        
            }
            else if (pressed_digit == 4) {
                quadTexCoord2f[0] = 0.5f; quadTexCoord2f[1] = 0.5f;
                quadTexCoord2f[2] = 0.5f; quadTexCoord2f[3] = 0.5f;
                quadTexCoord2f[4] = 0.5f; quadTexCoord2f[5] = 0.5f;
                quadTexCoord2f[6] = 0.5f; quadTexCoord2f[7] = 0.5f;
                GLES32.glUniform1i(texture_enable_uniform, 1);
        
            }	
            else {
                GLES32.glUniform1i(texture_enable_uniform, 0);
            }
