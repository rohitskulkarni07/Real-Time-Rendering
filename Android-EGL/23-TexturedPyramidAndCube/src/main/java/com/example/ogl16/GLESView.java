...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    private void display() {
        ...
        GLES32.glUseProgram(shaderProgramObject);
            ...
            Matrix.translateM(modelViewMatrix, 0, modelViewMatrix, 0, 1.75f, 0.0f, -5.5f);
		    ...
		    GLES32.glBindTexture(GLES32.GL_TEXTURE_2D, kundali_texture[0]);		//change state to texture for next upcoming geometry
