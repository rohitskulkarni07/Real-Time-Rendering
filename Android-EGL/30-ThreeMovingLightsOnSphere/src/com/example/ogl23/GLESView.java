...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    float[] light_ambient_green  = new float[] { 0.0f, 0.0f, 0.0f};
    float[] light_diffuse_green  = new float[] { 0.0f, 1.0f, 0.0f};
    float[] light_specular_green = new float[] { 0.0f, 1.0f, 0.0f};
    ...
    float[] material_ambient  = new float[] {0.0f, 0.0f, 0.0f}; 
    float[] material_diffuse  = new float[] {1.0f, 1.0f, 1.0f};
    float[] material_specular = new float[] {1.0f, 1.0f, 1.0f};
    ...
    private int[] la_uniform_PF = new int[3];
    private int[] ld_uniform_PF = new int[3];
    private int[] ls_uniform_PF = new int[3];
    private int[] lightPosition_uniform_PF = new int[3];
    ...
    private int[] la_uniform_PV = new int[3];
    private int[] ld_uniform_PV = new int[3];
    private int[] ls_uniform_PV = new int[3];
    private int[] lightPosition_uniform_PV = new int[3];
    ...
    private void initialize(GL10 gl) {
        ...
        final String fragmentShaderSourceCode_PF = String.format(
            ...
            "           ambient                            = u_la[i] * u_ka;                                                                                    \n"+
            "           diffuse                            = u_ld[i] * u_kd * max(dot(normalized_light_direction, normalized_transformed_normal), 0.0);         \n"+
            "           specular                           = u_ls[i] * u_ks * pow(max(dot(reflection_vector, normalized_view_vector),0.0), u_shininess);        \n"+
            "           phong_ads_light                    = phong_ads_light + ambient + diffuse + specular;                                                    \n"+
            "                                                                                                                                                   \n"+
            "       }                                                                                                                                           \n"+
            "                                                                                                                                                   \n"+
        ...
        la_uniform_PF[0]                          = GLES32.glGetUniformLocation(shaderProgramObject_PF,"u_la[0]");
        ld_uniform_PF[0]                          = GLES32.glGetUniformLocation(shaderProgramObject_PF,"u_ld[0]");
        ls_uniform_PF[0]                          = GLES32.glGetUniformLocation(shaderProgramObject_PF,"u_ls[0]");
        lightPosition_uniform_PF[0]               = GLES32.glGetUniformLocation(shaderProgramObject_PF,"u_light_position[0]");
        
        la_uniform_PF[1]                          = GLES32.glGetUniformLocation(shaderProgramObject_PF,"u_la[1]");
        ld_uniform_PF[1]                          = GLES32.glGetUniformLocation(shaderProgramObject_PF,"u_ld[1]");
        ls_uniform_PF[1]                          = GLES32.glGetUniformLocation(shaderProgramObject_PF,"u_ls[1]");
        lightPosition_uniform_PF[1]               = GLES32.glGetUniformLocation(shaderProgramObject_PF,"u_light_position[1]");
        
        la_uniform_PF[2]                          = GLES32.glGetUniformLocation(shaderProgramObject_PF,"u_la[2]");
        ld_uniform_PF[2]                          = GLES32.glGetUniformLocation(shaderProgramObject_PF,"u_ld[2]");
        ls_uniform_PF[2]                          = GLES32.glGetUniformLocation(shaderProgramObject_PF,"u_ls[2]");
        lightPosition_uniform_PF[2]               = GLES32.glGetUniformLocation(shaderProgramObject_PF,"u_light_position[2]");
        ...
        la_uniform_PV[2]                          = GLES32.glGetUniformLocation(shaderProgramObject_PV,"u_la[2]");
        ld_uniform_PV[2]                          = GLES32.glGetUniformLocation(shaderProgramObject_PV,"u_ld[2]");
        ls_uniform_PV[2]                          = GLES32.glGetUniformLocation(shaderProgramObject_PV,"u_ls[2]");
        lightPosition_uniform_PV[2]               = GLES32.glGetUniformLocation(shaderProgramObject_PV,"u_light_position[2]");
    ...
    private void display() {
        ...
        if(bLight == true) {
            ...
            light_position_red[1] = (float) (r * Math.sin(angle0));
            light_position_red[2] = (float) (r * Math.cos(angle0));
            light_position_red[3] = 1.0f;
            
            light_position_green[0] = (float) (r * Math.sin(angle1));
            light_position_green[1] = 0.0f;
            light_position_green[2] = (float) (r * Math.cos(angle1));
            light_position_green[3] = 1.0f;
            
            light_position_blue[0] = (float) (r * Math.sin(angle2));
            light_position_blue[1] = (float) (r * Math.cos(angle2));
            ...
            if(gbPV && bLight) {
                ...
                GLES32.glUniform3fv(la_uniform_PV[1], 1, light_ambient_green, 0);  
                GLES32.glUniform3fv(ld_uniform_PV[1], 1, light_diffuse_green, 0);  
                GLES32.glUniform3fv(ls_uniform_PV[1], 1, light_specular_green, 0); 
                GLES32.glUniform4fv(lightPosition_uniform_PV[1], 1, light_position_green, 0);
                
                GLES32.glUniform3fv(la_uniform_PV[2], 1, light_ambient_blue, 0);  
                GLES32.glUniform3fv(ld_uniform_PV[2], 1, light_diffuse_blue, 0);  
                GLES32.glUniform3fv(ls_uniform_PV[2], 1, light_specular_blue, 0); 
                GLES32.glUniform4fv(lightPosition_uniform_PV[2], 1, light_position_blue, 0);
                ...
                GLES32.glUniform3fv(la_uniform_PF[0], 1, light_ambient_red, 0);  
                GLES32.glUniform3fv(ld_uniform_PF[0], 1, light_diffuse_red, 0);  
                GLES32.glUniform3fv(ls_uniform_PF[0], 1, light_specular_red, 0); 
                GLES32.glUniform4fv(lightPosition_uniform_PF[0], 1, light_position_red, 0);
                
                GLES32.glUniform3fv(la_uniform_PF[1], 1, light_ambient_green, 0);  
                GLES32.glUniform3fv(ld_uniform_PF[1], 1, light_diffuse_green, 0);  
                GLES32.glUniform3fv(ls_uniform_PF[1], 1, light_specular_green, 0); 
                GLES32.glUniform4fv(lightPosition_uniform_PF[1], 1, light_position_green, 0);
                
                GLES32.glUniform3fv(la_uniform_PF[2], 1, light_ambient_blue, 0);  
                GLES32.glUniform3fv(ld_uniform_PF[2], 1, light_diffuse_blue, 0);  
                GLES32.glUniform3fv(ls_uniform_PF[2], 1, light_specular_blue, 0); 
                GLES32.glUniform4fv(lightPosition_uniform_PF[2], 1, light_position_blue, 0);
