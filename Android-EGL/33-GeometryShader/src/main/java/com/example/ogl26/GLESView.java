...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    private void initialize(GL10 gl) {
        ...
        final String vertexShaderSourceCode = String
        ...
        if (iShaderCompileStatus[0] == GLES32.GL_FALSE) {
            ...
            GLES32.glGetShaderiv(geometryShaderObject, GLES32.GL_INFO_LOG_LENGTH, iInfoLofLength, 0);
            if (iInfoLofLength[0] > 0) {

                szInfoLog = GLES32.glGetShaderInfoLog(geometryShaderObject);
                System.out.println("RSK: Geometry Shader Compilation Log = " + szInfoLog);
                uninitialized();
                System.exit(0);
            }
        }
        ...
        // write shader
        final String fragmentShaderSourceCode = String
                .format("#version 320 es                                                    \n"
                        + "                                                                 \n"
                        + "precision highp float;                                           \n"
                        + "out vec4 FragColor;                                              \n"
        ...
        final float triangleVertices[] = new float[] {
             0.0f, 1.0f, 0.0f, // apex
            -1.0f, -1.0f, 0.0f, // left-bootom
             1.0f, -1.0f, 0.0f // right-bootom
        };
    ...
    private void display() {
        ...
        Matrix.translateM(modelViewMatrix, 0, modelViewMatrix, 0, 0.0f, 0.0f, -4.0f);
