...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    private void display() {
        ...
        float[] sun_color   = new float[] {1.0f, 1.0f, 0.0f};
        float[] earth_color = new float[] {0.0f, 1.0f, 1.0f};
        float[] moon_color  = new float[] {0.725f, 0.725f, 0.8f};
        ...
        Matrix.translateM(modelMatrix, 0, modelMatrix, 0, 0.0f, 0.0f, -1.5f);
        ...
        //sun
        GLES32.glUniform3fv(colorUniform, 0, sun_color, 0);
        myStack.pushMatrix(modelMatrix);
        drawSphere();
        myStack.popMatrix(modelMatrix);
      
        //earth
        GLES32.glUniform3fv(colorUniform, 0, earth_color, 0);
        myStack.pushMatrix(modelMatrix);
          Matrix.rotateM(modelMatrix, 0, modelMatrix, 0, angle, 0.0f, 1.0f, 0.0f);
          Matrix.translateM(modelMatrix, 0, modelMatrix, 0, 1.5f, 0.0f, 0.0f);
          Matrix.scaleM(modelMatrix, 0, modelMatrix, 0, 0.45f, 0.45f, 0.45f);
          Matrix.rotateM(modelMatrix, 0, modelMatrix, 0, angle, 0.0f, 1.0f, 0.0f);
          ...
          //moon
          GLES32.glUniform3fv(colorUniform, 0, moon_color, 0);
          myStack.pushMatrix(modelMatrix);
          Matrix.translateM(modelMatrix, 0, modelMatrix, 0, 1.0f, 0.0f, 0.0f);
          Matrix.scaleM(modelMatrix, 0, modelMatrix, 0, 0.20f, 0.20f, 0.20f);
          Matrix.rotateM(modelMatrix, 0, modelMatrix, 0, angle, 0.0f, 1.0f, 0.0f);
