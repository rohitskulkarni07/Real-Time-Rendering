...
// * For Texture
ID3D11ShaderResourceView *gpID3D11ShaderResourceView_KundaliTexture = NULL;    //* resource being use for texture
ID3D11SamplerState *gpID3D11SamplerState_KundaliTexture = NULL;                //* create a sampler-state object that encapsulates sampling information for a texture
...
HRESULT initialize(void)
{
    ...
    // *Load texture 
    hr = LoadD3DTexture(L"Stone.bmp", &gpID3D11ShaderResourceView_KundaliTexture);
      if (FAILED(hr))
    {
        fopen_s(&gpFile, gszFileName, "a+");
