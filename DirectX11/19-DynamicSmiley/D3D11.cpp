...
HRESULT initialize(void)
{
    ...
    const char *pixelShaderSourceCode =
        ...
        "  }else{                                                                           \n"
        "       color = myTexture2D.Sample(mySamplerState, input.texCoords);                \n"
        "  }                                                                                \n"
        "   return(color);                                                                  \n"
        "}                                                                                  \n";
     ...
     * *For Texture
     *
     * *As we are sending array of texCoords dynamically
     * *mapsubresources and unmap will be done in display
     *
     */
...
void display(void)
{
    ...
    switch (giPressesDigit)
    {
    case 1:
        squareTexCoords[0] = 1.0; squareTexCoords[1] = 0.0;
        squareTexCoords[2] = 1.0; squareTexCoords[3] = 1.0;
        squareTexCoords[4] = 0.0; squareTexCoords[5] = 1.0;
        
        squareTexCoords[6] = 0.0; squareTexCoords[7] = 0.0;
        squareTexCoords[8] = 1.0; squareTexCoords[9] = 0.0;
        squareTexCoords[10] = 0.0; squareTexCoords[11] = 1.0;
        constantBuffer.keyPress = 1;

        break;

    case 2:
        squareTexCoords[0] = 0.5; squareTexCoords[1] = 0.5;     //  1  1
        squareTexCoords[2] = 0.5; squareTexCoords[3] = 1.0;     //  1 -1
        squareTexCoords[4] = 0.0; squareTexCoords[5] = 1.0;     // -1 -1

        squareTexCoords[6] = 0.0; squareTexCoords[7] = 0.5;     // -1  1
        squareTexCoords[8] = 0.5; squareTexCoords[9] = 0.5;     //  1  1
        squareTexCoords[10] = 0.0; squareTexCoords[11] = 1.0;   // -1 -1
        constantBuffer.keyPress = 2;

        break;

    case 3:
       squareTexCoords[0] = 2.0; squareTexCoords[1] = 0.0;
        squareTexCoords[2] = 2.0; squareTexCoords[3] = 2.0;
        squareTexCoords[4] = 0.0; squareTexCoords[5] = 2.0;
        
        squareTexCoords[6] = 0.0; squareTexCoords[7] = 0.0;
        squareTexCoords[8] = 2.0; squareTexCoords[9] = 0.0;
        squareTexCoords[10] = 0.0; squareTexCoords[11] = 2.0;
        constantBuffer.keyPress = 3;
        break;
    ...
    case 4:
        ...
        squareTexCoords[8] = 0.5; squareTexCoords[9] = 0.5;
        squareTexCoords[10] = 0.5; squareTexCoords[11] = 0.5;
        constantBuffer.keyPress = 4;
        break;
