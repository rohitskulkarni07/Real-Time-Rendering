...
struct CBUFFER
{
    ...
    XMVECTOR LA[3]; // ambient  component of light
    XMVECTOR LD[3]; // diffuse  component of light
    XMVECTOR LS[3]; // specular component of light
    ...
    XMVECTOR LightPosition[3]; // lights position
...
HRESULT initialize(void)
{
    ...
    const char *vertexShaderSourceCode =
        ...
        "   float3 lightDirection[3]: NORMAL1;                                                                          \n"
        ...
        "                                                                                                               \n"
        "       for(i = 0; i < 3; i++) {                                                                                \n"
        "           output.lightDirection[i] = (float3) lightPosition[i] - eyePosition.xyz;                             \n"
        "       }                                                                                                       \n"
        "                                                                                                               \n"
        "   }                                                                                                           \n"
    ...
    const char *pixelShaderSourceCode =     
        ...
        "       for(i = 0; i < 3; i++) {                                                                                                        \n"
        "                                                                                                                                       \n"
        "           float3 normalized_lightDirection = normalize(input.lightDirection[i]);                                                      \n"
        "           float3 reflectionVector = reflect(-normalized_lightDirection, normalized_transformedNormal);                                \n"
        "                                                                                                                                       \n"
        "           float3 ambient = la[i].xyz * ka.xyz;                                                                                        \n"
        "           float3 diffuse = ld[i].xyz * kd.xyz * max(dot(normalized_lightDirection, normalized_transformedNormal), 0.0);               \n"
        "           float3 specular = ls[i].xyz * ks.xyz * pow(max(dot(reflectionVector, normalized_viewerVector), 0.0), materialShinnines);    \n"
...
void display(void)
{
    ...
    if (gbLights)
    {
        ...
        constantBuffer.LD[0] = XMVectorSet(1.0, 0.0f, 0.0f, 1.0f);
        constantBuffer.LS[0] = XMVectorSet(1.0, 0.0, 0.0, 1.0f);
        constantBuffer.LightPosition[0] = XMVectorSet(0.0f, r * sin(light0_Angle),-r * cos(light0_Angle), 1.0f);
        ...
        constantBuffer.LightPosition[1] = XMVectorSet(r * sin(light1_Angle), 0.0f, -r*cos(light1_Angle), 1.0f);
        ...
        constantBuffer.LightPosition[2] = XMVectorSet(r * sin(light2_Angle), r * cos(light2_Angle), 0.0f, 1.0f);
