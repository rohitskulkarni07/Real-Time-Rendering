...
unsigned int guiNumberOfSegment;
...
HRESULT initialize(void)
{
    ...
    const char *vertexShaderSourceCode =
        ...
        "   float4 color: COLOR;                                    \n"
        "};                                                         \n"
        "vertex_output main(float2 pos:POSITION, float4 col:COLOR)  \n"
        "{                                                          \n"
    ...
    const char *HullShaderSourceCode =
        ...
        "   :SV_TESSFACTOR;                                                 \n"
        "}                                                                  \n"
        "hull_constant_output hull_constant_function()                      \n"
        "{                                                                  \n"
    ...
    ID3D10Blob *pID3DBlob_HullShaderCode = NULL;
    pID3DBlob_Error = NULL;
    ...
    ID3D10Blob *pID3DBlob_DomainShader = NULL;
    pID3DBlob_Error = NULL;
    ...
    hr = gpID3D11Device->CreateDomainShader(pID3DBlob_DomainShader->GetBufferPointer(),
                                           pID3DBlob_DomainShader->GetBufferSize(),
                                           NULL,
