...
GLfloat glfColors[10][3] = { {1.0f,0.0f,0.0f} , //r
							{0.0f,1.0f,0.0f} ,	//g
							{0.0f,0.0f,1.0f},	//b
							{0.0f,1.0f,1.0f},	//c
							{1.0f,0.0f,1.0f},	//m
							...
							{1.0f,1.0f,1.0f},	//w
							{0.5f,0.5f,0.5f},	//gray
							{0.96f,0.58f,0.11f},//orange
							{0.61f,0.0f,0.36f} };//purple
...
void drawCircle(void) {
	...
	int c = 0;
	for (GLfloat i = 0.99f; i >= 0.0f; i = i - 0.1f) {
		...
		for (GLfloat angle = 0.0f; angle <= 2 * PI; angle = angle + 0.0001f) {
			...
			glVertex3f(i* cos(angle), i* sin(angle), 0.0f);
		}
