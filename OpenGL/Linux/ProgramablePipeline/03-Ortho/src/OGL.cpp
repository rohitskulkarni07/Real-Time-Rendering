...
void resize(int width, int height) {
	...
	if(width <= height) {
		orthographicProjectionMatrix = ortho(-100.0f, 100.0f, (-100.0f*((GLfloat)height/(GLfloat)width)), (100.0f*((GLfloat)height/(GLfloat)width)), -100.0f, 100.0f);
	}else {
		orthographicProjectionMatrix = ortho((-100.0f*((GLfloat)width/(GLfloat)height)), (100.0f*((GLfloat)width/(GLfloat)height)), -100.0f, 100.0f, -100.0f, 100.0f);
	}
