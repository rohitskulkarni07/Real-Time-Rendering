...
GLuint		tissilationControlShaderObject;
GLuint		tissilationEvaluationShaderObject;
...
void initialize(void) {
	...
	//*************************************************************************************
	//							 *** TISSILATION CONTROL SHADER ***
	//*************************************************************************************

	// create TC shader
	tissilationControlShaderObject = glCreateShader(GL_TESS_CONTROL_SHADER);

	// write the shader source code
	const GLchar* tessilationControlShaderSourceCode = 
	"#version 450 core																						\n" \
	"\n 																									\n" \
	"																										\n" \
	...
	// provide source code to shader 
	glShaderSource(tissilationControlShaderObject, 1, (const GLchar**) &tessilationControlShaderSourceCode, NULL);

	// compile shader source code
	glCompileShader(tissilationControlShaderObject);
	...
	glGetShaderiv(tissilationControlShaderObject, GL_COMPILE_STATUS, &shaderCompilationStatus);
	if(shaderCompilationStatus == GL_FALSE) {

		glGetShaderiv(tissilationControlShaderObject, GL_INFO_LOG_LENGTH, &infoLogLenght);
		if(infoLogLenght > 0) {
			...
			if(szInfoLog != NULL) {
				...
				GLsizei written;
				glGetShaderInfoLog(tissilationControlShaderObject, infoLogLenght, &written, szInfoLog);
				printf("\n*** Tissilation Control Shader Compilation Status ***\n");
				printf("%s\n", szInfoLog);
				free(szInfoLog);
				uninitialize();
				exit(0);
	...
	//*************************************************************************************
	//							 *** TISSILATION EVALUATION SHADER ***
	//*************************************************************************************

	// create TEC shader
	tissilationEvaluationShaderObject = glCreateShader(GL_TESS_EVALUATION_SHADER);

	// write the shader source code
	const GLchar* tessilationEvaluationShaderSourceCode = 
	"#version 450 core																						\n" \
	"\n 																									\n" \
	"																										\n" \
	"layout(isolines) in;																					\n" \
	...
	// provide source code to shader 
	glShaderSource(tissilationEvaluationShaderObject, 1, (const GLchar**) &tessilationEvaluationShaderSourceCode, NULL);

	// compile shader source code
	glCompileShader(tissilationEvaluationShaderObject);
	...
	glGetShaderiv(tissilationEvaluationShaderObject, GL_COMPILE_STATUS, &shaderCompilationStatus);
	if(shaderCompilationStatus == GL_FALSE) {

		glGetShaderiv(tissilationEvaluationShaderObject, GL_INFO_LOG_LENGTH, &infoLogLenght);
		if(infoLogLenght > 0) {
			...
			if(szInfoLog != NULL) {
				...
				GLsizei written;
				glGetShaderInfoLog(tissilationEvaluationShaderObject, infoLogLenght, &written, szInfoLog);
				printf("\n*** Tissilation Evaluation Shader Compilation Status ***\n");
				printf("%s\n", szInfoLog);
				free(szInfoLog);
				uninitialize();
				exit(0);
	...
	glAttachShader(shaderProgramObject, tissilationControlShaderObject);

	// attach TES to shader program object
	glAttachShader(shaderProgramObject, tissilationEvaluationShaderObject);
