//  04-Orthographic Projection
//  OGL.m
//  
//
//  Created by Rohit Kulkarni on 06/01/22.
//
...
@implementation MyOpenGLView {
    ...
    mat4 orthographicProjectionMatrix; // from vmath 4x4 Matrix
...
-(void) reshape {
    ...
    if (rect.size.width <= rect.size.height) {
		orthographicProjectionMatrix = ortho(-100.0f, 100.0f, (-100.0f * (rect.size.height / rect.size.width)), (100.0f * (rect.size.height / rect.size.width)), -100.0f, 100.0f);
	}
	else {
		orthographicProjectionMatrix = ortho(-100.0f, 100.0f, (-100.0f * (rect.size.width/ rect.size.height)), (100.0f * (rect.size.width / rect.size.height)), -100.0f, 100.0f);
	}
