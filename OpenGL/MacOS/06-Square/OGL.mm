//  06-Perspective Projection with Square Shape
//  OGL.m
//  
//
...
-(void) prepareOpenGL {
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(squareVertices), squareVertices, GL_STATIC_DRAW); //feed the data to VRAM buffer
