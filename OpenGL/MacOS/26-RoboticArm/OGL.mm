...
-(void) drawView {
   ...
   glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
	...
	mat4 modelViewMatrix 			= vmath::translate(0.0f, 0.0f, -12.0f);
	...
	pushMatrix(modelViewMatrix);
		...
		modelViewMatrix = modelViewMatrix * vmath::rotate((float)shoulder, 0.0f, 0.0f, 1.0f) * vmath::translate(1.0f,0.0f,0.0f);
		pushMatrix(modelViewMatrix);
			modelViewMatrix = modelViewMatrix * vmath::scale(2.0f, 0.5f, 1.0f);
			[self draw:modelViewMatrix];
		popMatrix(&modelViewMatrix);

		modelViewMatrix = modelViewMatrix * vmath::translate(1.0f, 0.0f, 0.0f) * vmath::rotate((float)elbow, 0.0f, 0.0f, 1.0f) * vmath::translate(1.0f, 0.0f, 0.0f);
...
-(void) draw: (mat4) modelViewMatrix {
