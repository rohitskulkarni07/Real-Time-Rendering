...
GLfloat rotateMatrix_X[16];
GLfloat rotateMatrix_Y[16];
GLfloat rotateMatrix_Z[16];
...
void initialize(void) {
	...
	//_____________________--Bridging Complete--___________________

	//Fill The Matrices With Apropriate Value
	...
	//_____________________OpenGL Specific_________________________
...
void display(void) {
	...
	//glLoadIdentity();
	glLoadMatrixf(identityMatrix); //this function internally loads the give matrix

	//glTranslatef(0.0f, 0.0f, -6.0f);
	glMultMatrixf(translationMatrix); //this funtion internally loads as well as multiply the matrix with privously loaded matrix

	//glScalef(0.75f, 0.75f, 0.75f);
	glMultMatrixf(scaleMatrix);

	angleCube_rad = gfAngle * (M_PI)/180.0f;

	//glRotatef(gfAngle, 1.0f, 0.0f, 0.0f);
	rotateMatrix_X[0] = 1.0f;
	rotateMatrix_X[1] = 0.0f;
	rotateMatrix_X[2] = 0.0f;
	rotateMatrix_X[3] = 0.0f;
	rotateMatrix_X[4] = 0.0f;
	rotateMatrix_X[5] = cos(angleCube_rad);
	rotateMatrix_X[6] = sin(angleCube_rad);
	rotateMatrix_X[7] = 0.0f;
	rotateMatrix_X[8] = 0.0f;
	rotateMatrix_X[9] = -sin(angleCube_rad);
	rotateMatrix_X[10] = cos(angleCube_rad);
	rotateMatrix_X[11] = 0.0f;
	rotateMatrix_X[12] = 0.0f;
	rotateMatrix_X[13] = 0.0f;
	rotateMatrix_X[14] = 0.0f;
	rotateMatrix_X[15] = 1;

	//glRotatef(gfAngle, 0.0f, 1.0f, 0.0f);
	rotateMatrix_Y[0] = cos(angleCube_rad);
	rotateMatrix_Y[1] = 0.0f;
	rotateMatrix_Y[2] = -sin(angleCube_rad);
	rotateMatrix_Y[3] = 0.0f;
	rotateMatrix_Y[4] = 0.0f;
	rotateMatrix_Y[5] = 1.0f;
	rotateMatrix_Y[6] = 0.0f;
	rotateMatrix_Y[7] = 0.0f;
	rotateMatrix_Y[8] = sin(angleCube_rad);
	rotateMatrix_Y[9] = 0.0f;
	rotateMatrix_Y[10] = cos(angleCube_rad);
	rotateMatrix_Y[11] = 0.0f;
	rotateMatrix_Y[12] = 0.0f;
	rotateMatrix_Y[13] = 0.0f;
	rotateMatrix_Y[14] = 0.0f;
	rotateMatrix_Y[15] = 1.0f;

	//glRotatef(gfAngle, 0.0f, 0.0f, 1.0f);
	rotateMatrix_Z[0] = cos(angleCube_rad);
	rotateMatrix_Z[1] = sin(angleCube_rad);
	rotateMatrix_Z[2] = 0.0f;
	rotateMatrix_Z[3] = 0.0f;
	rotateMatrix_Z[4] = -sin(angleCube_rad);
	rotateMatrix_Z[5] = cos(angleCube_rad);
	rotateMatrix_Z[6] = 0.0f;
	rotateMatrix_Z[7] = 0.0f;
	rotateMatrix_Z[8] = 0.0f;
	rotateMatrix_Z[9] = 0.0f;
	rotateMatrix_Z[10] = 1.0f;
	rotateMatrix_Z[11] = 0.0f;
	rotateMatrix_Z[12] = 0.0f;
	rotateMatrix_Z[13] = 0.0f;
	rotateMatrix_Z[14] = 0.0f;
	rotateMatrix_Z[15] = 1.0f;

	glMultMatrixf(rotateMatrix_X);
	glMultMatrixf(rotateMatrix_Y);
	glMultMatrixf(rotateMatrix_Z);
