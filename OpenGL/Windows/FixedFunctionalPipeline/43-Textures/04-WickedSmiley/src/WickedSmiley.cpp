...
void initialize(void) {
	...
	LoadGLTexture(&guiSmiley_Texture, MAKEINTRESOURCE(SMILEY_BITMAP));
...
void display(void) {
	...
	glBindTexture(GL_TEXTURE_2D, guiSmiley_Texture);	//change state to texture for next upcoming geometry
...
void uninitialize(void) {
	...
	glDeleteTextures(1, &guiSmiley_Texture);
}
