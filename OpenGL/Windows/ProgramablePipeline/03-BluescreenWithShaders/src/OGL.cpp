...
//For GLSL Extensions This Library Must Be Before #include <gl\gl.h>
...
void uninitialize(void) {
	...
	//detach shader from vertex shader
	glDetachShader(shaderProgramObjet, vertexShaderObjet);
	
	//detach shader from fragment shader
	glDetachShader(shaderProgramObjet, fragmentShaderObjet);

	//delete vertex shader
	glDeleteShader(vertexShaderObjet);
	vertexShaderObjet = 0;

	//delete fragment shader
	glDeleteShader(fragmentShaderObjet);
	fragmentShaderObjet = 0;
...
//Link
// link.exe OGL.obj /LIBPATH:C:\glew - 2.1.0\lib\Release\Win32 glew32.lib user32.lib gdi32.lib kernel32.lib

//Compile And Linking In Single Command
//	cl.exe OGL.cpp /I C:\glew-2.1.0\include /link /LIBPATH:C:\glew-2.1.0\lib\Release\Win32  gdi32.lib user32.lib rico.res