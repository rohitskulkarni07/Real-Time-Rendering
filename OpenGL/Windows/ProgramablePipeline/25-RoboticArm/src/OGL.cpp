...
void display(void) {
	...
	viewMatrix			= vmath::lookat(vec3(0.0f, 0.0f, 1.0f), vec3(0.0f, 0.0f, 0.0f), vec3(0.0f, 1.0f, 0.0f));
	projectionMatrix	= perspectiveProjectionMatrix;

	pushMatrix(modelMatrix);

		modelMatrix = modelMatrix * vmath::rotate((float)shoulder, 0.0f, 0.0f, 1.0f) * vmath::translate(1.0f,0.0f,0.0f);
		pushMatrix(modelMatrix);
		...
		modelMatrix = modelMatrix * vmath::translate(1.8f, 0.0f, 0.0f) * vmath::rotate((float)elbow, 0.0f, 0.0f, 1.0f) * vmath::translate(1.0f, 0.0f, 0.0f);
...
void draw(mat4 modelMatrix, mat4 viewMatrix, mat4 projectionMatrix) {
	...
	glDrawElements(GL_TRIANGLES, sphere_data.numberOfIndices, GL_UNSIGNED_SHORT, 0);
...
//cl.exe OGL.cpp Sphere.cpp MyStack.cpp /I C:\glew-2.1.0\include /link user32.lib gdi32.lib kernel32.lib rico.res /LIBPATH:C:\glew-2.1.0\lib\Release\Win32 glew32.lib