...
void initialize(void) {
	...
	*	by string.Any source code previously stored in the shader object is completely replaced.The number
	...
	{ 
		1.0f, 0.89f, 0.89f,	// red-shade
		0.89f, 0.94f, 1.0f,	// green-shade
		0.90, 0.89f, 0.94f,	// blue-shade
		0.98f, 0.8f, 1.0f	// yellow-shade
	};
	...
	glBindVertexArray(vao_square);
		...
		//glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0); //In Indexed Base VBO NEVER UNBIND
