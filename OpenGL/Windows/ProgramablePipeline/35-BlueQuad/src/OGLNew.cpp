...
void initialize(void) {
	...
	*	by string.Any source code previously stored in the shader object is completely replaced.The number
	...
	glBindAttribLocation(shaderProgramObjet, RSK_ATTRIBUTE_COLOR, "vColor");
	...
	////for color of quad
	glVertexAttrib3f(RSK_ATTRIBUTE_COLOR, 0.0f, 0.0f, 1.0f);
...
//cl.exe OGLNew.cpp /I C:\glew-2.1.0\include /link user32.lib gdi32.lib kernel32.lib rico.res /LIBPATH:C:\glew-2.1.0\lib\Release\Win32 glew32.lib