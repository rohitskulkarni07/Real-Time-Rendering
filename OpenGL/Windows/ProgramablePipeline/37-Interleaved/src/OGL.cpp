...
GLuint vao_cube; //geometry

GLuint vbo_position_cube;	//properties for geometry
GLuint vbo_normal_cube;
GLuint guiMarble_texture;
...
void initialize(void) {
	...
	LoadGLTexture(&guiMarble_texture, MAKEINTRESOURCE(MARBLE_BITMAP));
...
void display(void) {
	...
	glUseProgram(shaderProgramObject);
		...
		glBindTexture(GL_TEXTURE_2D, guiMarble_texture);
