...
function init() {
    ...
    orthographicProjectMatrix = mat4.create();
...
function resize() {
    ...
    if(canvas.width <= canvas.height) {
        mat4.ortho(orthographicProjectMatrix, -100.0, 100.0, (-100.0 * (canvas.height/canvas.width)), (100.0 * (canvas.height/canvas.width)), -100.0, 100.0);
    } else {
        mat4.ortho(orthographicProjectMatrix, (-100.0 * (canvas.width/canvas.height)), (100.0 * (canvas.width/canvas.height)),-100.0, 100.0, -100.0, 100.0);
    }
}
...
function draw() {
    ...
    mat4.multiply(modelViewProjectionMatrix, orthographicProjectMatrix, modelViewMatrix);
