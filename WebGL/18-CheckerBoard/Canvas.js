...
var checkImageArr = new Uint8Array(64*64*4);
...
var quadVertices = new Float32Array(3*4);
...
function init() {
    ...
    var quadTexCoord2f = new Float32Array([
        0.0, 0.0, 
		0.0, 1.0,
		1.0, 1.0,
		1.0, 0.0    
    ...
    gl.bufferData(gl.ARRAY_BUFFER,  quadTexCoord2f,gl.STATIC_DRAW);
    ...
    gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA,CHECKIMAGEWIDTH,CHECKIMAGEHEIGHT,0,gl.RGBA,gl.UNSIGNED_BYTE,checkImageArr);
...
function makeCheckImage() {
	...
	for (i = 0; i < CHECKIMAGEHEIGHT; i++) {
		...
		for (j = 0; j < CHECKIMAGEWIDTH; j++) {
			...
			checkImageArr[4*(i*64+j)+0] = c;
			checkImageArr[4*(i*64+j)+1] = c;
			checkImageArr[4*(i*64+j)+2] = c;
			checkImageArr[4*(i*64+j)+3] = 255;
...
function draw() {
    ...
    quadVertices[0] = -2.0; quadVertices[1] = -1.0; quadVertices[2] = 0.0;
    quadVertices[3] = -2.0; quadVertices[4] = 1.0; quadVertices[5] = 0.0;
    quadVertices[6] = 0.0; quadVertices[7] = 1.0; quadVertices[8] = 0.0;
    quadVertices[9] = 0.0; quadVertices[10] = -1.0; quadVertices[11] = 0.0;
    ...
    quadVertices[6] = 2.41421;  quadVertices[7] = 1.0;      quadVertices[8] = -1.41421;
    quadVertices[9] = 2.41421;  quadVertices[10] = -1.0;    quadVertices[11] = -1.41421;
